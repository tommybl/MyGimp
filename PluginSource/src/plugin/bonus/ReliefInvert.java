 ...
 * @author Tommy
 */
public class ReliefInvert implements IPlugin {
    @Override
    public BufferedImage perform(BufferedImage img) 
    {
            BufferedImage imggrey = new BufferedImage(img.getWidth(), img.getHeight(), img.getType());
            BufferedImage res = new BufferedImage(img.getWidth(), img.getHeight(), img.getType());
            BufferedImage invert = new BufferedImage(img.getWidth(), img.getHeight(), img.getType());
            int w = img.getWidth();
            int h = img.getHeight();
            int[][] mat = new int[5][5];
            float[][] conv = 
            ...
            for (int i = 0; i < img.getWidth(); i++)
                for (int j = 0; j < img.getHeight(); j++) {
                    ...
                    g = (argb >> 8) & 0xff;
                    b = (argb) & 0xff;
                    invert.setRGB(i, j, new Color(255-r,255-g,255-b,a).getRGB());
                }
